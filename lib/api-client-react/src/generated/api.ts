...
/**
 * @summary Get current weather in Rio de Janeiro
 */
export const getGetRioWeatherUrl = () => {
  return `/api/grok-carioca/weather`;
};

export const getRioWeather = async (
  options?: RequestInit,
): Promise<WeatherData> => {
  return customFetch<WeatherData>(getGetRioWeatherUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetRioWeatherQueryKey = () => {
  return [`/api/grok-carioca/weather`] as const;
};

export const getGetRioWeatherQueryOptions = <
  TData = Awaited<ReturnType<typeof getRioWeather>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getRioWeather>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetRioWeatherQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getRioWeather>>> = ({
    signal,
  }) => getRioWeather({ signal, ...requestOptions });
...
export type GetRioWeatherQueryResult = NonNullable<
  Awaited<ReturnType<typeof getRioWeather>>
>;
export type GetRioWeatherQueryError = ErrorType<unknown>;

/**
 * @summary Get current weather in Rio de Janeiro
 */

export function useGetRioWeather<
  TData = Awaited<ReturnType<typeof getRioWeather>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetRioWeatherQueryOptions(options);
...
/**
 * @summary Get a random fun activity suggestion for Rio de Janeiro
 */
export const getGetRoleSuggestionUrl = () => {
  return `/api/grok-carioca/role-suggestion`;
};

export const getRoleSuggestion = async (
  options?: RequestInit,
): Promise<RoleSuggestion> => {
  return customFetch<RoleSuggestion>(getGetRoleSuggestionUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetRoleSuggestionQueryKey = () => {
  return [`/api/grok-carioca/role-suggestion`] as const;
};

export const getGetRoleSuggestionQueryOptions = <
  TData = Awaited<ReturnType<typeof getRoleSuggestion>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getRoleSuggestion>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetRoleSuggestionQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getRoleSuggestion>>
  > = ({ signal }) => getRoleSuggestion({ signal, ...requestOptions });
...
export type GetRoleSuggestionQueryResult = NonNullable<
  Awaited<ReturnType<typeof getRoleSuggestion>>
>;
export type GetRoleSuggestionQueryError = ErrorType<unknown>;

/**
 * @summary Get a random fun activity suggestion for Rio de Janeiro
 */

export function useGetRoleSuggestion<
  TData = Awaited<ReturnType<typeof getRoleSuggestion>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetRoleSuggestionQueryOptions(options);
